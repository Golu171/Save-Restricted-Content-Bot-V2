...
API_ID = os.getenv("API_ID", "16214694")
API_HASH = os.getenv("API_HASH", "7545825d90eb7adae543d59909c73121")
BOT_TOKEN = os.getenv("BOT_TOKEN", "8154916973:AAHlVUTje28NxA2pbAwjDseP1TZg1EFW2Gg")
MONGO_URI = os.getenv("MONGO_DB", "mongodb+srv://sandeep123:<db_password>@cluster0.ggtof.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
OWNER_ID = list(map(int, os.getenv("OWNER_ID", "5543709855").split())) # list seperated via space
